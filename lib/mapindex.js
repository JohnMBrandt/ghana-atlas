...
$(function () {
    ...
    var kwahu = L.leafletGeotiff(url = "includes/kwahu.tif",
                                         options = { band: 0, displayMin: 0.01,
                                                     displayMax: 1, colorScale: 'viridis', 
                                                     clampLow: false, clampHigh: true, pane: "right"})
    ...
    L.control.sideBySide(myLayer1, [myLayer2, ghana, mamprusi, upperwest, bonoeast, kwahu]).addTo(m);
